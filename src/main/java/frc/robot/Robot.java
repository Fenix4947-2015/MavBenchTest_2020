...
public class Robot extends TimedRobot {
  ...
  public static RevMotorSubsystem m_RevMotorSubsystem = new RevMotorSubsystem();
  public static RevPIDSubsystem m_RevPIDSubsystem = new RevPIDSubsystem();
  public static OI m_oi;
  public static ExampleCommand m_command = new ExampleCommand();
  public static RevMotorCommand m_RevMotorCommand = new RevMotorCommand();
